...
decoder.load_state_dict(torch.load('experiment/final_exp/decoder_final.pth', map_location='cpu'))
encoder.eval()
decoder.eval()
    ...
    if form.validate_on_submit():
        ...
        if form.content.data and form.content.data.filename:
            if allowed_file(form.content.data.filename):
                ...
                error = 'Invalid content image format. Please use PNG, JPG, or JPEG.'
        else:
        ...
        if form.style.data and form.style.data.filename:
            if allowed_file(form.style.data.filename):
                ...
                error = 'Invalid style image format. Please use PNG, JPG, or JPEG.'
        else:
            style_filename = form.style_path.data

        # Perform style transfer
        if content_filename and style_filename and error is None:
